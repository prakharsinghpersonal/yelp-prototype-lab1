...
import { getProfile, updateProfile, uploadProfilePhoto, getPreferences, updatePreferences } from '../services/userService'
...
export default function ProfilePage() {
  ...
  const handlePhotoUpload = async (e) => {
    ...
    try {
      ...
      setProfile((p) => ({ ...p, profile_pic_url: res.data.url }))
    } catch {
      ...
      {tab === 'profile' && profile && (
        <form onSubmit={handleProfileSave} className="card p-6 space-y-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-20 h-20 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center text-3xl">
